...
builder.Services.AddDbContext<IranMapDbContext>(options =>
...
app.MapControllerRoute(
    name: "default",
    pattern: "{controller=IranMap}/{action=Index}/{id?}");

//using (var scope = app.Services.CreateScope())
//{
//    var context = scope.ServiceProvider.GetRequiredService<IranMapDbContext>();
